...
\fancypagestyle{titlepage}{
	\fancyhf{}
	\fancyhead[C]{\includegraphics[width=0.6\textwidth]{images/banner.png}}
...
\title{
    \vspace{2cm}{\bf{\Huge Dark-Hex: \\An Imperfect Information Game}}\\ % Change the title
    % \vspace{1cm}{\bf \large by M Bedir Tapkan}\\
    \vspace{5cm}{\normalsize A thesis submitted in partial fulfillment \\of the requirements for the degree of \\\bf{Master's in Computing Science}}\\
    \vspace{2cm}{\bf{\large University of Alberta}}\\
    \vspace{3cm}\normalsize \today
}
\date{}
...
\input{chapters/background}
    \input{chapters/bg/cgt}

    \input{chapters/bg/rl}
    \input{chapters/bg/cfr}

\input{chapters/dark-hex}
    \input{chapters/dark-hex/2by2}    
    \input{chapters/dark-hex/AbruptDH}
    \input{chapters/dark-hex/notes}

...
def convert(strategy, num_cols, pid):
    new_strategy = {}
...
if __name__ == "__main__":
    file_path = "darkhex/data/strategy_data/3x3_0_def/game_info.pkl"
    with open(file_path, "rb") as f:
        game_info = pickle.load(f)
    new_strategy = convert(game_info['strategy'], game_info['num_cols'], game_info['player'])
    # save new strategy
